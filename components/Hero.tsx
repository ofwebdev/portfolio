...
const Hero = () => {
  return (
    <section id="home" className="container mx-auto">
      <div className="flex flex-col text-center items-center justify-center animate-fadeIn animation-delay-2 my-10 py-16 sm:py-32 md:py-52 md:flex-row md:space-x-4 md:text-left md:p-4">
